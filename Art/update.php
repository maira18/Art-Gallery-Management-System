...
<div class="container" >
    ...
    <hr>
    <form class="form-horizontal" role="form" action="includes/artistUpdate.php" method="post" enctype="multipart/form-data">
        <div class="row">
            <div class="col-md-3">
                <div class="text-center">
                    <img src="<?php echo $data['profilePicture']?>" class="avatar img-circle" style="margin:5px 5px;box-sizing: border-box; height: 3cm; width: 3cm; border-radius: 50%">
            ...
            <div class="col-md-9 personal-info">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <input class="form-control" type="text" name="desc" value="<?php echo $data['description']?>" required>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <input class="form-control" type="password" name="conpass" required>
                        </div>
                    </div>
                    <div class="form-group">
