...
<div class="row">
    <div class="col-3">
        <div class="container">
            <div id="left-panel">
                ...
                <table>
                    <tr>
                        <a class="btn btn-outline-dark" role="button" href="update.php" data-bs-hover-animate="pulse" id="settings" style="margin-top:25px;margin-left:60px;color:rgb(0,0,0);background-color:rgba(255,255,255,0);">Settings</a>
                    </tr>
                    <tr>
                        <a class="btn btn-outline-dark" role="button" href="gallery.php" id="gallery" style="margin-top:25px;margin-left:60px;color:rgb(0,0,0);background-color:rgba(255,255,255,0);">Gallery</a>
                    </tr>
                    <tr>
                        <a class="btn btn-outline-dark" role="button" href="uploadArt.php" id="upload-art" style="margin-top:25px;margin-left:60px;color:rgb(0,0,0);background-color:rgba(255,255,255,0);">Upload Art</a>
                    </tr>
                    <tr>
                        <a class="btn btn-outline-dark" role="button" href="yoursales.php" id="view-sales" style="margin-top:25px;margin-left:60px;color:rgb(0,0,0);background-color:rgba(255,255,255,0);">View Sales</a>
                    </tr>
                </table>
            </div>
        </div>
    ...
    <div class="col">
        <div class="container">
            <div>
                <?php
                $query = "Select path, description from artwork where artistID = '$id'";
